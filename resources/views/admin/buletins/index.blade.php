            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div class="flex items-center gap-4">
                        <form action="{{ route('admin.buletins.index') }}" method="GET" class="flex flex-wrap gap-4 items-center">
                    ...
                    <a href="{{ route('admin.buletins.create') }}" class="font-bold py-2 px-4 bg-white border-2 border-green-700 text-green-700 rounded-lg hover:bg-green-300 hover:border-green-300">
                        Add New
                    </a>
                </div>
                ...
                <table class="min-w-full table-auto">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2">
                                <img src="{{ $buletin->cover }}" alt="{{ $buletin->title }}" class="w-[120px] h-[90px] object-cover rounded-lg">
                            </td>
                            <td class="px-4 py-2">
                                {{ $buletin->title }}
                            </td>
                            ...
                            <td class="px-4 py-8 flex gap-3">
                                <a href="{{ route('admin.buletins.edit', $buletin) }}" class="text-yellow-500 mt-2">
                                ...
                                <form action="{{ route('admin.buletins.destroy', $buletin) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus artikel ini?');">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <a href="{{ route('admin.buletins.show', $buletin) }}" class="px-4 py-2 bg-indigo-700 text-white rounded-lg font-bold">
                                    Detail
                                </a>
                            </td>
                        </tr>
                ...
                <div class="mt-5">
                    {{ $buletins->links() }} <!-- Pagination Links -->
                </div>
            </div>
        </div>
    </div>
