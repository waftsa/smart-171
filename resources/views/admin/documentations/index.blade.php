            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div class="flex items-center gap-4">
                        <form action="{{ route('admin.documentations.index') }}" method="GET" class="flex flex-wrap gap-4 items-center">
                    ...
                    <a href="{{ route('admin.documentations.create') }}" class="font-bold py-2 px-4 bg-white border-2 border-green-700 text-green-700 rounded-lg hover:bg-green-300 hover:border-green-300">
                        Add New
                    </a>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2">
                                ...
                                @else
                                    <img src="{{ asset('images/default-thumbnail.jpg') }}" alt="Default Thumbnail" class="w-[120px] h-[90px] object-cover rounded-lg">
                                @endif
                            </td>
                            <td class="px-4 py-2">
                                {{ $documentation->title }}
                            ...
                            <td class="px-4 py-2">
                                {{ $documentation->updated_at->format('d M Y') }}
                            </td>
                            <td class="px-4 py-2">
                            ...
                            <td class="px-4 py-8 flex gap-3">
                                <a href="{{ route('admin.documentations.edit', $documentation) }}" class="text-yellow-500 mt-2">
                                ...
                                <form action="{{ route('admin.documentations.destroy', $documentation) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus donasi ini?');">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <a href="{{ route('admin.documentations.show', $documentation) }}" class="px-4 py-2 bg-indigo-700 text-white rounded-lg font-bold">
                                    Detail
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-4">
                                Belum ada dokumentasi kegiatan saat ini.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
                ...
                <div class="mt-5">
                    {{ $documentations->links() }} <!-- Pagination Links -->
                </div>
            </div>
        </div>
    </div>
