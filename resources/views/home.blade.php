        ...
        <div class="slide absolute inset-0 w-full h-full transition-opacity duration-1000 {{ $index === 0 ? 'opacity-100' : 'opacity-0' }}"
            ...
            <div class="absolute inset-0 flex justify-start items-start">
                <div class="md:w-full w-full h-full bg-gradient-to-r from-[#1D4161] to-transparent pt-32 md:pt-48 p-6 md:p-10 text-left z-10 transform">
                    ...
                    <p class="mt-2 mb-10 max-w-md md:max-w-lg text-gray-100 text-sm md:text-lg">{{ $slider->caption ?? $slider->about ?? $slider->summary }}</p>
...
<section id="countUp" class="absolute top-[520px] left-0 right-0 z-10">
    <script type="module" src="https://cdn.jsdelivr.net/npm/countup.js/dist/countUp.min.js"></script>
    ...
    <div class="flex justify-center">
        ...
        <div class="grid grid-cols-3 sm:grid-cols-3 gap-2">
            ...
            <div class="text-[#1D4161] p-4 text-center" id="programs">
                <h3 class="text-xs sm:text-sm md:text-md font-semibold">Programs</h3>
                <p class="mt-2 text-sm sm:text-base md:text-xl" id="programs-count">0</p>
            </div>

            <!-- Orang Tua Asuh -->
            <div class="text-[#1D4161] p-4 text-center" id="ortu-asuh">
                <h3 class="text-xs sm:text-sm md:text-md font-semibold">Orang Tua Asuh</h3>
                <p class="mt-2 text-sm sm:text-base md:text-xl" id="ortu-asuh-count">0</p>
            </div>

            <!-- Jumlah Donasi -->
            <div class="text-[#1D4161] p-4 text-center" id="donation">
                <h3 class="text-xs sm:text-sm md:text-md font-semibold">Jumlah Donasi</h3>
                <p class="mt-2 text-sm sm:text-base md:text-xl" id="donation-count">0</p>
            </div>
        </div>
                ...
                entries.forEach(entry => {
                    if (entry.isIntersecting) {
                        if (entry.target.id === "programs") {
                            ...
                            startCountUp('ortu-asuh-count', 0, 2300, 0, 2.5);
                        } else if (entry.target.id === "donation") {
                            startCountUp('donation-count', 0, 200000000, 0, 2.5);
                        }
