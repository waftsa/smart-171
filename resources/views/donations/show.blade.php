            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg pt-3 pb-3 p-3 sm:pr-5 sm:pl-5 flex flex-col gap-y-2 mt-2">
                <div class="mt-6 mb-4 text-center">
                    ...
                    <div class="mt-6 flex justify-center space-x-4">
                        <a href="https://api.whatsapp.com/send?text={{ urlencode($donation->name . ' ' . url()->current()) }}" target="_blank" class="text-green-500 hover:text-green-700">
                        ...
                        <a href="https://t.me/share/url?url={{ urlencode(url()->current()) }}&text={{ urlencode($donation->name) }}" target="_blank" class="text-blue-500 hover:text-blue-700">
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" target="_blank" class="text-blue-700 hover:text-blue-900">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                            </svg>
                        </a>
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($donation->name) }}" target="_blank" class="text-blue-400 hover:text-blue-600">
